...
export { default as EditStocks } from './dashboard/crud/stock/EditStocks'
...
export { default as Buyers } from './dashboard/charts/BestBuyer'
export { default as ProductsStats } from './dashboard/charts/ProductStats'
